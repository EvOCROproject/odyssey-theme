 ...
 */const p=globalThis,y=p.ShadowRoot&&(p.ShadyCSS===void 0||p.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,_=Symbol(),b=new WeakMap;let S=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==_)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(y&&t===void 0){const i=e!==void 0&&e.length===1;i&&(t=b.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&b.set(e,t))}return t}toString(){return this.cssText}};const O=s=>new S(typeof s=="string"?s:s+"",void 0,_),A=(s,...t)=>{const e=s.length===1?s[0]:t.reduce((i,r,o)=>i+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+s[o+1],s[0]);return new S(e,s,_)},T=(s,t)=>{if(y)s.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const i=document.createElement("style"),r=p.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=e.cssText,s.appendChild(i)}},v=y?s=>s:s=>s instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return O(e)})(s):s;/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const I={attribute:!0,type:String,converter:u,reflect:!1,hasChanged:$},q=(s=I,t,e)=>{const{kind:i,metadata:r}=e;let o=globalThis.litPropertyMetadata.get(r);if(o===void 0&&globalThis.litPropertyMetadata.set(r,o=new Map),o.set(e.name,s),i==="accessor"){const{name:n}=e;return{set(a){const g=t.get.call(this);t.set.call(this,a),this.requestUpdate(n,g,s)},init(a){return a!==void 0&&this.P(n,void 0,s),a}}}if(i==="setter"){const{name:n}=e;return function(a){const g=this[n];t.call(this,a),this.requestUpdate(n,g,s)}}throw Error("Unsupported decorator location: "+i)};function N(s){return(t,e)=>typeof e=="object"?q(s,t,e):((i,r,o)=>{const n=r.hasOwnProperty(o);return r.constructor.createProperty(o,n?{...i,wrapped:!0}:i),n?Object.getOwnPropertyDescriptor(r,o):void 0})(s,t,e)}const V=d`<svg
	width="24"
	height="24"
	viewBox="0 0 24 24"
	fill="none"
...
>
	...
	<path
		...
		fill="#FBA92C"
	/>
</svg>`;var K=Object.defineProperty,W=Object.getOwnPropertyDescriptor,P=(s,t,e,i)=>{for(var r=i>1?void 0:i?W(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=(i?n(t,e,r):n(r))||r);return i&&r&&K(t,e,r),r};const C="/odyssey-theme/",G=[{name:"dark",icon:V,label:"Dark"},{name:"earth",icon:H,label:"Earth"},{name:"sand",icon:J,label:"Sand"}];let m=class extends l{constructor(){super(...arguments),this._doc=document.firstElementChild,this.theme=null}_getCurrentTheme(){const s=localStorage.getItem("theme");s?this._setTheme(s):this._setTheme("earth")}firstUpdated(){this._getCurrentTheme()}_setTheme(s){s==="earth"?this._doc?.removeAttribute("data-theme"):this._doc?.setAttribute("data-theme",s);const t=document.querySelector("#home-hero-image");t&&(s==="dark"&&(t.src=`${C}assets/images/home/dark-hero.jpg`),s==="earth"&&(t.src=`${C}assets/images/home/earth-hero.jpg`),s==="sand"&&(t.src=`${C}assets/images/home/sand-hero.jpg`)),localStorage.setItem("theme",s),this.theme=s}render(){return d`
