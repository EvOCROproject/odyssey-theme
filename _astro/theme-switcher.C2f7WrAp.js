...
>
	...
	<path
		...
		fill="#FBA92C"
	/>
</svg>`;var K=Object.defineProperty,W=Object.getOwnPropertyDescriptor,P=(i,t,e,s)=>{for(var r=s>1?void 0:s?W(t,e):t,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=(s?n(t,e,r):n(r))||r);return s&&r&&K(t,e,r),r};const C="/odyssey-theme/",G=[{name:"dark",icon:V,label:"Dark"},{name:"earth",icon:H,label:"Earth"},{name:"sand",icon:J,label:"Sand"}];let m=class extends l{constructor(){super(...arguments),this._doc=document.firstElementChild,this.theme=null}_getCurrentTheme(){const i=localStorage.getItem("theme");i?this._setTheme(i):this._setTheme("earth")}firstUpdated(){this._getCurrentTheme()}_setTheme(i){this._doc?.setAttribute("data-theme",i);const t=document.querySelector("#home-hero-image");t&&(i==="dark"&&(t.src=`${C}assets/images/home/dark-hero.jpg`),i==="earth"&&(t.src=`${C}assets/images/home/earth-hero.jpg`),i==="sand"&&(t.src=`${C}assets/images/home/sand-hero.jpg`)),localStorage.setItem("theme",i),this.theme=i}render(){return d`
      <div class="theme-switcher__container">
        ${G.map(i=>d`
            <div class="theme-select__container">
              <button
                @click=${()=>this._setTheme(i.name)}
                ?active=${this.theme===i.name}
                title=${`Enable ${i.label} Theme`}
              >
                ${i.icon}
              </button>
              <p>${i.label}</p>
